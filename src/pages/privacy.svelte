...
<div class="all" style="min-height: calc(100vh - 92px);">
    ...
    <div class="py-10">
        <h1 class="text-6xl text-left text-bookmark-blue md:mx-72 py-2"><strong>Privacy Policy</strong></h1>
    ...
    <div class="py-4 mt-4">
        <div class="sm:w-3/4 md:mx-72 px-2 flex flex-col">
            <p class="text-left text-bookmark-grey mt-4 whitespace-pre-wrap mb-8">Our privacy policy is coming soon!
            </p>
        </div>
    </div>
</div>
